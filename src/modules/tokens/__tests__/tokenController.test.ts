...
import { sendTokenEmail } from '../tokenMail';
...
describe('tokenController', () => {
  ...
  test('sendToken success sends email and responds', async () => {
    ...
    jest.spyOn(require('../../../core/utils/utils'), 'generateUserToken').mockReturnValue('tokenx');
    jest.spyOn(require('../tokenMail'), 'sendTokenEmail').mockResolvedValue(undefined);
    ...
    expect(require('../tokenMail').sendTokenEmail).toHaveBeenCalled();
  });
});
